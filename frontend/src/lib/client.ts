...
export function Environment(name: string): BaseURL {
    return `https://${name}-meeting-notes-ts-u3bi.encr.app`
}
...
/**
 * Client is an API client for the meeting-notes-ts-u3bi Encore application.
 */
...
export namespace pexels {
    ...
    export class ServiceClient {
        ...
        public async searchPhoto(_query: string): Promise<SearchPhotoResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("GET", `/images/${encodeURIComponent(_query)}`)
            return await resp.json() as SearchPhotoResponse
        }
    }
}
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "meeting-notes-ts-u3bi-Generated-TS-Client (Encore/v1.45.2)";
        }
